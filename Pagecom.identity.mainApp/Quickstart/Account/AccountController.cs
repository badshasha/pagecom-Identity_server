...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        // todo we create this code 
        // [+++]
        // we add  this code because in default identity server check agained the test users 
        // if we using sql server we have to configure it 
        ...
        public AccountController(
            ...
            IEventService events, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, RoleManager<IdentityRole> roleManager, TestUserStore users = null)
        {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // if activation test user activate this 
        ...
        public async Task<IActionResult> Logout(LogoutInputModel model)
        {
            ...
            {
                // delete local authentication cookie  // test user [------]
